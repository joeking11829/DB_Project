...
<iframe src="admin_main.php?q=SELECT Course.*,Teacher.tName, IFNULL(COUNT(Attend.sId), 0) as attendCount FROM Course JOIN Teacher ON Teacher.tId = Course.tId LEFT JOIN Attend ON Attend.cId = Course.cId GROUP BY Course.cId&t=Attend&k=cId&f=tName&o=Attend&s=<?php echo $_POST['sId']?>" height=300 width=1400>
</iframe>
</center>
</body>
</html>
